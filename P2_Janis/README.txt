...
The makefile for this program (frontEnd) is titled makefile.
This makefile can be ran by typing the command:
        > "make"

If the program has been made already (.o files and frontEnd* exists),
...
Comments:
> For "frontEnd < [file]", the standard input is being read in from
...
> If you try the invokation using "frontEnd < [file]" and the file does not exist, or
